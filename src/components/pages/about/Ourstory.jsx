                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-12 my-5 text-center py-5 ">
                    <div className="rounded-lg overflow-hidden shadow-lg bg-white">
                        <div className="py-8">
                            ...
                            <h2 className='text-secondary-light mb-2 mt-3 font-bold truncate'>A Dream Born from Passion</h2>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-lg bg-white">
                        <div className=" py-8">
                            <i className="fas fa-money-check text-primary text-h1"></i>
                            <h2 className='text-secondary-light mb-2 mt-3 font-bold truncate'>The Meaning Behind the Name</h2>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-lg bg-white">
                        <div className=" py-8">
                            <i className="fas fa-money-check text-primary text-h1"></i>
                            <h2 className='text-secondary-light mb-2 mt-3 font-bold'>Building a Movement, Not Just a Business</h2>
                            <p className="text-gray-dark text-h6 text-justify px-6">
