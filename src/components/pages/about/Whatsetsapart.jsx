                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-4 my-5 text-justify py-5 sm:px-6">
                    <div className=" bg-white rounded-lg overflow-hidden shadow-lg">
                        <div className="px-6 py-4">
                            <p className="font-semibold text-h5 text-primary leading-6 text-center">Fast and Hassle-Free Funding</p>
                    ...
                    <div className="  bg-white rounded-lg overflow-hidden shadow-lg">
                        <div className="px-6 py-4">
                            <p className="font-semibold text-h5 text-primary leading-6 text-center">Tailored Solutions</p>
                    ...
                    <div className=" bg-white rounded-lg overflow-hidden shadow-lg">
                        <div className="px-6 py-4">
                            <p className="font-semibold text-h5 text-primary leading-6 text-center">Trusted Partnerships</p>
                    ...
                    <div className=" bg-white rounded-lg overflow-hidden shadow-lg">
                        <div className="px-6 py-4">
                            <p className="font-semibold text-h5 text-primary leading-6 text-center">Transparent Terms</p>
