...
export default function Benefits() {
    return (
        <>
        <div className='xl:container py-20 px-6 lg:px-16'>
            <div className="mx-auto grid lg:grid-cols-2 md:grid-cols-1 gap-4 ">
            <div className="px-6"><img className="rounded-lg w-auto h-full  md:w-full object-cover mx-auto" src=" src/assets/img/about-home.jpg" alt="about-img" /></div>
