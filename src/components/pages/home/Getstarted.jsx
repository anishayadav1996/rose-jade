            ...
            <div className="xl:container lg:px-16  mx-auto py-20 px-6">
                <div className="mx-auto grid lg:grid-cols-2 grid-cols-1 gap-12 ">
                    ...
                    <div className="flex flex-col space-y-5 px-6">
                        ...
                        <p className='text-justify text-h5 pt-2 leading-6'>Ready to take your business to the next level? At Rose Jade, we make the process simple and transparent. Whether you’re looking for immediate funding through our Merchant Cash Advance, a flexible Line of Credit, or essential Equipment Financing, we’re here to help.</p>
                        <p className='text-justify text-h5 pt-2 leading-6'>Our experts will guide you every step of the way, ensuring that you get the right solution for your needs. Just a few quick details about your business, and you’re on your way to accessing the funds that empower growth. Let’s build your success story together.
                        </p>
                    </div>
                </div>
            </div>
