        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-12 my-5 text-center py-5 sm:px-6">
          <div className=" rounded-lg overflow-hidden shadow-lg bg-white">
            <div className="px-6 py-8">
              ...
              <h2 className="text-secondary-light  mt-3 font-bold">
                Merchant Cash Advance
              </h2>
              <p className=" text-h6 text-center  leading-6 pt-2 pb-5">
                Quick funding to fuel your business growth.
              </p>

              <Btn value={"Read More"} txtcolor={"primary"} urllink={"merchant-cash"}/>
            </div>
          </div>
          <div className=" rounded-lg overflow-hidden shadow-lg bg-white">
            <div className="px-6 py-8">
              ...
              <p className=" text-h6 text-center y leading-6 pt-2 pb-5">
                Flexible financing for every business need.
              </p>

              <Btn value={"Read More"} txtcolor={"primary"} urllink={"line-of-credit"}/>
            </div>
          </div>
          <div className=" rounded-lg overflow-hidden shadow-lg bg-white">
            <div className="px-6 py-8">
